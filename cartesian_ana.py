...
def main(argv=sys.argv[1:]):
    ...
    parser.add_argument("--plot_spatial", type=bool, help='Plot spatial stuff, defaults to False', default=True)
    ...
    # Load vectors produced by cartesian.py
    try:
